...
g lb21gap = lb2111 - ub2121
g ub21gap = ub2111 - lb2121
g lb2299gap = lb229911 - ub229921
g ub2299gap = ub229911 - lb229921
g lb12299gap = lb1229911 - ub1229921
g ub12299gap = ub1229911 - lb1229921
g lb2499gap = lb249911 - ub249921
g ub2499gap = ub249911 - lb249921
g lb12499gap = lb1249911 - ub1249921
g ub12499gap = ub1249911 - lb1249921
lab var lb21gap "No Assumption"
lab var lb2299gap "Independence + Level Set"
lab var lb2499gap "Independence + Level Set + Monotonicity"
lab var lb12299gap "Orthogonality + Indep + Level Set"
lab var lb12499gap "Orthogonality + Indep + Level Set + Monotonicity"

format * %3.2f
format me %2.0f

tw (connected lb21gap ub21gap me, clpattern(solid solid) lcolor(red red) ms(i i) mlabp(6 6 6 6) mlabel(lb21gap ub21gap) mlabs(tiny tiny tiny tiny) mlabc(red red)) ///
	(connected lb2299gap ub2299gap me, clpattern(dash dash) lcolor(blue blue) ms(i i) mlabp(6 6 6 6) mlabel(lb2299gap ub2299gap) mlabs(tiny tiny tiny tiny) mlabc(blue blue)) ///
	(connected lb12299gap ub12299gap me, clpattern(shortdash_dot shortdash_dot) lcolor(ltblue ltblue) ms(i i) mlabp(6 6 6 6) mlabel(lb12299gap ub12299gap) mlabs(tiny tiny tiny tiny) mlabc(ltblue ltblue)) ///
	(connected lb2499gap ub2499gap me, clpattern(longdash_dot longdash_dot) lcolor(dkgreen dkgreen) ms(i i) mlabp(6 6 6 6) mlabel(lb2499gap ub2499gap) mlabs(tiny tiny tiny tiny) mlabc(dkgreen dkgreen)) ///
	(connected lb12499gap ub12499gap me, clpattern(shortdash shortdash) lcolor(midgreen midgreen) ms(i i) mlabp(6 6 6 6) mlabel(lb12499gap ub12499gap) mlabs(tiny tiny tiny tiny) mlabc(midgreen midgreen)), ///
	...
	ytitle("Labor Force Participation Gap" "(Non-Disabled - Disabled)", size(*.7)) yline(0 1, lc(gs0 gs0)) saving(olf_04_gap, replace) xlab(0 5 10 20 30 40, labs(*.75)) leg(size(vsmall) order(1 3 5 7 9) r(5) rowg(*.1)) ylab(-1(.25)1, labs(*.5)) /// 
...
tw (connected lb21gap ub21gap me, clpattern(solid solid) lcolor(red red) ms(i i) mlabp(6 6 6 6) mlabel(lb21gap ub21gap) mlabs(tiny tiny tiny tiny) mlabc(red red)) ///
	...
	(connected lb12499gap ub12499gap me, clpattern(shortdash shortdash) lcolor(midgreen midgreen) ms(i i) mlabp(6 6 6 6) mlabel(lb12499gap ub12499gap) mlabs(tiny tiny tiny tiny) mlabc(midgreen midgreen)), ///
	title("Bounds Under Misclassification:", si(*.8)) subtitle("With and Without Additional Assumptions", si(*.6)) xtitle("Maximum Allowed Degree of Misclassification", si(*.6)) ///
	ytitle("Labor Force Participation Gap" "(Non-Disabled - Disabled)", size(*.7)) yline(0 1, lc(gs0 gs0)) saving(olf_08_gap, replace) xlab(0 5 10 20 30 40, labs(*.75)) leg(size(vsmall) order(1 3 5 7 9) r(5) rowg(*.1)) ylab(-1(.25)1, labs(*.5)) /// 
	graphregion(fcolor(white)) plotregion(fcolor(white)) graphregion(ifcolor(white)) plotregion(ifcolor(white)) graphregion(ilcolor(white)) plotregion(ilcolor(white)) plotregion(margin(b+2))	
...
egen inccat=cut(oecd_nonlabor), at(-60000,0,10,200,725,42000) icodes
g id=_n
expand 2
bys id: g t=_n
g y=disb
...
tw (connected lb21gap ub21gap me, clpattern(solid solid) lcolor(red red) ms(i i) mlabp(6 6 6 6) mlabel(lb21gap ub21gap) mlabs(tiny tiny tiny tiny) mlabc(red red)) ///
	...
	(connected lb12499gap ub12499gap me, clpattern(shortdash shortdash) lcolor(midgreen midgreen) ms(i i) mlabp(6 6 6 6) mlabel(lb12499gap ub12499gap) mlabs(tiny tiny tiny tiny) mlabc(midgreen midgreen)), ///
	title("Bounds Under Misclassification:", si(*.8)) subtitle("With and Without Additional Assumptions", si(*.6)) xtitle("Maximum Allowed Degree of Misclassification", si(*.6)) ///
	ytitle("Labor Force Participation Gap" "(Non-Disabled - Disabled)", size(*.7)) yline(0 1, lc(gs0 gs0)) saving(olf_14_gap, replace) xlab(0 5 10 20 30 40, labs(*.75)) leg(size(vsmall) order(1 3 5 7 9) r(5) rowg(*.1)) ylab(-1(.25)1, labs(*.5)) /// 
	graphregion(fcolor(white)) plotregion(fcolor(white)) graphregion(ifcolor(white)) plotregion(ifcolor(white)) graphregion(ilcolor(white)) plotregion(ilcolor(white)) plotregion(margin(b+2))	
